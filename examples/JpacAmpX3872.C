...
void JpacAmpX3872(double ebeamE = 5, double pbeamE = 41, int nEvents = 5e4) {
  ...
  amplitude_sum sum(ptr, {&X3872rho, &X3872omega}, "Sum");
  ...
  auto jpac = new JpacModelQ2W{&sum, {x},{2212}, 0, 1, 2.0};
  ...
  Writer *ascii_io = new WriterAscii(Form("out/x3872_elspectro_%d_%d.txt",(int)ebeamE,(int)pbeamE),run);
